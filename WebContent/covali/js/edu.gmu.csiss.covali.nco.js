...
edu.gmu.csiss.covali.nco = {
    ...
    ncraDialogContent: function() {
        ...
        content += '	<div class="col-md-9">';
        content += '		<input id="ncra-outfile" name="ncra-outfile" value="ncra_result.nc" class="form-control" required>';
        content += '	</div>';
        content += '  </div><br/>';
    ...
    ncboDialogContent: function() {
        ...
        content += '	<div class="col-md-9">';
        content += '		<input id="ncbo-outfile" name="ncbo-outfile" value="ncbo_result.nc" class="form-control" required>';
        content += '	</div>';
        content += '  </div><br/>';
