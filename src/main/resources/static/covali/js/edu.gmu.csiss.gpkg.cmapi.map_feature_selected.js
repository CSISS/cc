...
edu.gmu.csiss.gpkg.cmapi.map_feature_selected = {
    ...
    responders : {
        ...
        googlemaps : function(sender, message, channel) 
        {
            ...
            {
                // only called once
                edu.gmu.csiss.gpkg.cmapi.map_feature_common.setSelected( message );
...
//                console.log( "[" + channel + ":googlemaps] is done" );
    ...
    subscribe : function() 
    {
        cmajs.runtimes.browser.mediator.subscribe( 
        {
            ...
            {
                edu.gmu.csiss.gpkg.cmapi.map_feature_selected.responders.googlemaps(sender, message, channel);
                edu.gmu.csiss.gpkg.cmapi.map_feature_selected.responders.openlayers(sender, message, channel);
            }
        });
    },
    ...
    init : function()
    {
        edu.gmu.csiss.gpkg.cmapi.map_feature_selected.subscribe();
        edu.gmu.csiss.gpkg.cmapi.map_feature_selected.register();

        console.log("[map_feature_selected] initialized");
    }
};
