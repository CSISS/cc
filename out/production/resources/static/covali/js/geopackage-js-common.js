...
// --------------------------------------------------------------------
// Appended by Gil Heo              
              edu.gmu.csiss.gpkg.cmapi.map_feature_common.removeAllFeatureIdList();
// --------------------------------------------------------------------
 ...
 // -------------------------------------------------------------
       ...
       var zoom = edu.gmu.csiss.gpkg.cmapi.map_feature_common.latLngToDistance(
               minY, minX, maxY, maxX );

       cmajs.runtimes.browser.mediator.publish( {
           sender: "geoPackageTestMenu",
       ...
       edu.gmu.csiss.gpkg.cmapi.geopackage_test.goToMainPage();
 ...
 // -------------------------------------------------------------    
  ...
  //  Appended by Gil Heo            
  // --------------------------------------------------------     
        var idList = edu.gmu.csiss.gpkg.cmapi.map_feature_common.getFeatureIdList( table );
...
//                channel: "map.feature.hide",
  ...
  /*
        ...
        for ( var i=0; i < idList.length; i++ )
        {
            featureArray.push( { "featureId": idList[i] } );
        }
...
//            channel: "map.feature.hide",
  ...
  */      
        ...
        edu.gmu.csiss.gpkg.cmapi.map_feature_common.removeFeatureIdList( table );
  // --------------------------------------------------------     
...
//  Appended by Gil Heo            
// --------------------------------------------------------            
            var uuid = cmajs.utils.getUUID();
            edu.gmu.csiss.gpkg.cmapi.map_feature_common.appendFeatureId( table, uuid );
